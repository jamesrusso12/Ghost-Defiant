...
**File:** `Assets/Scripts/Combat/GunScript.cs:19-30, 139-209`
...
[GunScript] Projectile created:
  - Mass: 0.01kg
  - Velocity: 15m/s
  - Gravity: 1x
[ProjectileController] Initialized. Collider disabled for 0.05s
[ProjectileController] Collider enabled at (x, y, z)
[ProjectileController] ===== COLLISION =====
  Hit: [name]
  Layer: [layer name]
  Position: (x, y, z)
[ProjectileController] Impact with: [name]
[ProjectileController] Invoking OnShootAndHit for: [name]
```
...
**File:** `Assets/Scripts/Combat/GunScript.cs:321-384`
...
**File:** `Assets/Scripts/Combat/GunScript.cs:386-421`
...
1. **Assets/Scripts/Combat/GunScript.cs**
   ...
   - Lines 139-209: Enhanced CreateProjectile() with optimized physics
   - Lines 229: Reduced collision enable delay
   - Lines 321-384: Enhanced collision detection with better logging
   - Lines 386-421: Improved HandleImpact() with priority ghost detection
